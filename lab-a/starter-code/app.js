...
function sumArray(sumArr) { //eslint-disable-line
  let addNums = sum(sum(sumArr[0], sumArr[1])[0], sumArr[2])[0];
  let addNumsString = `${ sumArr[0] },${ sumArr[1] },${ sumArr[2] } was passed in as an array of numbers, and ${ addNums } is their sum.`;
...
function multiplyArray(multArr) { //eslint-disable-line
  let multiplyNums = multiply( multiply( multArr[0], multArr[1] )[0], multArr[2] )[0]; 
  let multiplyNumsString = `The numbers ${ multArr[0] },${ multArr[1] },${ multArr[2] } have a product of ${ multiplyNums }.`;
    
  return [multiplyNums, multiplyNumsString];
}
